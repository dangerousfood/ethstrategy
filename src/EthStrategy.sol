    ...
    TReentrancyGuard
{
    ...
    uint256 constant public MINTER_ROLE = uint256(keccak256("MINTER_ROLE"));
    /// @dev The role of the pauser can pause transfers of tokens
    uint256 constant public PAUSER_ROLE = uint256(keccak256("PAUSER_ROLE"));
    ...
    function rageQuit(uint256 amount, uint256 proposalId, address[] calldata assets) external nonreentrant notGovernance {
    ...
    /// @inheritdoc GovernorPreventLateQuorum
    function proposalDeadline(uint256 proposalId) public view virtual override(GovernorPreventLateQuorum, Governor) returns (uint256) {
